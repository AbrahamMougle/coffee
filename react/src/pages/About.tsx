...
export default function About() {
  return (
    <>
      {/* Section Héro */}
      <section
        className="relative flex-grow flex items-center justify-center h-[75vh] overflow-hidden"
      >
        <div
        ...
        <div className="relative container mx-auto px-6 md:px-12 py-24">
          <div className="bg-white/70 p-8 rounded-xl backdrop-blur-[2px] border border-white/80 shadow-sm">
